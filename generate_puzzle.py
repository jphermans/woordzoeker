...
<body>
    ...
    <script>
        ...
        function updateSelection() {{ document.querySelectorAll('.cell').forEach(cell => {{ if (!cell.classList.contains('found')) cell.classList.remove('selected'); }}); selectedCells.forEach(pos => {{ const cell = document.querySelector('.cell[data-row="' + pos.row + '"][data-col="' + pos.col + '"]'); if (cell ) cell.classList.add('selected'); }}); }}
